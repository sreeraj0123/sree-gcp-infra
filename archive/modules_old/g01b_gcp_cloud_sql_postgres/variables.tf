...
variable "vpc_name" {
  description = "The name of the VPC where the Private IP will be enabled."
  type        = string
}

variable "ip_range" {
  description = "The private IP range for the Cloud SQL instance. Must be in CIDR notation."
  type        = string
}
